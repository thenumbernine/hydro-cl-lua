...
//// MODULE_DEPENDS: <?=cons_t?> <?=solver_t?> <?=normal_t?> rotate real3s3_rotate real3x3s3_rotate
...
#define <?=eigen_leftTransform?>(\
	...
	real3x3s3 const d_lll = real3x3s3_swap((inputU)->d_lll, n.side);						/* 3-20 */\
	real3s3 const K_ll = real3s3_swap((inputU)->K_ll, n.side);							/* 21-26 */\
...
//// MODULE_DEPENDS: <?=solver_t?> <?=cons_t?> <?=normal_t?> rotate <?=initCond_codeprefix?> real3x3s3_rotate real3s3_rotate
...
#define <?=eigen_rightTransform?>(\
	...
	\
	real3s3 gamma_ll = real3s3_swap((eig)->gamma_ll, n.side);\
	real3s3 gamma_uu = real3s3_swap((eig)->gamma_uu, n.side);\
\
...
\
	...
	(resultU)->d_lll = real3x3s3_swap((resultU)->d_lll, n.side);						/* 3-20 */\
	(resultU)->K_ll = real3s3_swap((resultU)->K_ll, n.side);							/* 21-26 */\
	(resultU)->Z_l = real3_swap((resultU)->Z_l, n.side);							/* 28-30 */\
}

//// MODULE_NAME: <?=eigen_fluxTransform?>
//// MODULE_DEPENDS: <?=solver_t?> <?=cons_t?> <?=normal_t?> real3x3s3_rotate real3s3_rotate
...
\
	...
	real3x3s3 d_lll = real3x3s3_swap((input)->d_lll, n.side);		/* 3-20 */\
	real3s3 K_ll = real3s3_swap((input)->K_ll, n.side);			/* 21-26 */\
