...
*/
	...
	{
		name = 'Triple-Point Shock Intersection',
		getInitCondCode = function(self)
			return [[
real const xseventh = (solver->initCondMins.x * 6. + solver->initCondMaxs.x) / 7.;
if (x.x < xseventh) {
	rho = 1.;
	P = 1.;
	//gamma = 1.5;	// oof, my scheme doesn't support varying gamma ...
} else {
	if (x.y > mids.y) {
		rho = 0.125;
		P = 0.1;
